...
// fetch a list of customers from a database
...
//fetch user single record from the database
function getCustomer($customerParams){
    ...
    $customeId = mysqli_real_escape_string($conn, $customerParams['id']);

    $query = "SELECT * FROM customers WHERE id='$customeId' LIMIT 1";
    $result = mysqli_query($conn, $query);
...
function deleteCustomer($customerParams){
    ...
    elseif ($customerParams['id'] == null) { // check if the id isset but there is no value
        return error422("Enter the customer id");
    }
